...
<html lang="en">
  <head>
	...
	<body class="img js-fullheight" style="overflow:hidden; background-image:linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), url(image/1.PNG); font-family: poppins">
	<header >
	...
	<section class="ftco-section">
		<div class="container">
			<div class="row justify-content-center">
					...
					<h1 class="heading-section" >Electronics</h1>
